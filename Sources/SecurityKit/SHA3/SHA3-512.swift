...
public extension SHA3 {
    struct SHA512 {
        ...
        public func finalize() -> SHA512Digest {
            ...
            SHA3.process(Self.self, block: block, hash: &hash)
            return SHA512Digest(hash.reduce(into: [UInt8]()) {
...
// MARK: - SHA3.SHA512.SHA512Digest

public extension SHA3.SHA512 {
    struct SHA512Digest: Sequence, Hashable, ContiguousBytes, CustomStringConvertible {
        ...
        public var description: String {
            "SHA3-512 digest: \(self.map { String(format: "%02x", $0) }.joined())"
        }
    }
}

// MARK: - SHA3.SHA512 + HashFunction

extension SHA3.SHA512: HashFunction {}

// MARK: - SHA3.SHA512 + SHA3HashFunction

extension SHA3.SHA512: SHA3HashFunction {}

// MARK: - SHA3.SHA512.SHA512Digest + Digest

extension SHA3.SHA512.SHA512Digest: Digest {}
