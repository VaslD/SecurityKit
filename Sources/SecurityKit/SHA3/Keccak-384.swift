...
public extension SHA3 {
    struct Keccak384 {
        ...
        public func finalize() -> Keccak384Digest {
            let block = read(self.pad(), as: UInt64.self)

            var hash = self.accumulatedHash
            SHA3.process(Self.self, block: block, hash: &hash)
            return Keccak384Digest(hash.reduce(into: [UInt8]()) {
...
// MARK: - SHA3.Keccak384.Keccak384Digest

public extension SHA3.Keccak384 {
    struct Keccak384Digest: Sequence, Hashable, ContiguousBytes, CustomStringConvertible {
        ...
        public var description: String {
            "Keccak-384 digest: \(self.map { String(format: "%02x", $0) }.joined())"
        }
    }
}

// MARK: - SHA3.Keccak384 + HashFunction

extension SHA3.Keccak384: HashFunction {}

// MARK: - SHA3.Keccak384 + SHA3HashFunction

extension SHA3.Keccak384: SHA3HashFunction {}

// MARK: - SHA3.Keccak384.Keccak384Digest + Digest

extension SHA3.Keccak384.Keccak384Digest: Digest {}
