...
public extension SHA3 {
    struct Keccak256 {
        ...
        public func finalize() -> Keccak256Digest {
            let block = read(self.pad(), as: UInt64.self)

            var hash = self.accumulatedHash
            SHA3.process(Self.self, block: block, hash: &hash)
            return Keccak256Digest(hash.reduce(into: [UInt8]()) {
...
// MARK: - SHA3.Keccak256.Keccak256Digest

public extension SHA3.Keccak256 {
    struct Keccak256Digest: Sequence, Hashable, ContiguousBytes, CustomStringConvertible {
        ...
        public var description: String {
            "Keccak-256 digest: \(self.map { String(format: "%02x", $0) }.joined())"
        }
    }
}

// MARK: - SHA3.Keccak256 + HashFunction

extension SHA3.Keccak256: HashFunction {}

// MARK: - SHA3.Keccak256 + SHA3HashFunction

extension SHA3.Keccak256: SHA3HashFunction {}

// MARK: - SHA3.Keccak256.Keccak256Digest + Digest

extension SHA3.Keccak256.Keccak256Digest: Digest {}
