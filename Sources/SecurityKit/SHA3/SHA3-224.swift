...
public extension SHA3 {
    struct SHA224 {
        ...
        public func finalize() -> SHA224Digest {
            ...
            SHA3.process(Self.self, block: block, hash: &hash)
            return SHA224Digest(hash.reduce(into: [UInt8]()) {
...
// MARK: - SHA3.SHA224.SHA224Digest

public extension SHA3.SHA224 {
    struct SHA224Digest: Sequence, Hashable, ContiguousBytes, CustomStringConvertible {
        ...
        public var description: String {
            "SHA3-224 digest: \(self.map { String(format: "%02x", $0) }.joined())"
        }
    }
}

// MARK: - SHA3.SHA224 + HashFunction

extension SHA3.SHA224: HashFunction {}

// MARK: - SHA3.SHA224 + SHA3HashFunction

extension SHA3.SHA224: SHA3HashFunction {}

// MARK: - SHA3.SHA224.SHA224Digest + Digest

extension SHA3.SHA224.SHA224Digest: Digest {}
