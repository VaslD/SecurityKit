...
public extension SHA3 {
    struct SHA384 {
        ...
        public func finalize() -> SHA384Digest {
            ...
            SHA3.process(Self.self, block: block, hash: &hash)
            return SHA384Digest(hash.reduce(into: [UInt8]()) {
...
public extension SHA3.SHA384 {
    struct SHA384Digest: Sequence, Hashable, ContiguousBytes, CustomStringConvertible {
        ...
        public var description: String {
            "SHA3-384 digest: \(self.map { String(format: "%02x", $0) }.joined())"
        }
    }
}

// MARK: - SHA3.SHA384 + HashFunction

extension SHA3.SHA384: HashFunction {}

// MARK: - SHA3.SHA384 + SHA3HashFunction

extension SHA3.SHA384: SHA3HashFunction {}

// MARK: - SHA3.SHA384.SHA384Digest + Digest

extension SHA3.SHA384.SHA384Digest: Digest {}
